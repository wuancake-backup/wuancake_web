...
* @Last Modified time: 2015-12-18 16:52:51
*/
...
function preparePlaceholder(){
    ...
    placeholder.setAttribute("src","images/Koala.jpg");//相对路径相对的是html文件的
    ...
    // document.getElementsByTagName("body")[0].appendChild(description);//插入到body节点的最后，并不能插入到指定位置
    // document.body.appendChild(placeholder);   //HTML-DOM
    
    var gallery = document.getElementById("imagegallery");
    // gallery.parentNode.insertBefore(placeholder, gallery);
    // gallery.parentNode.insertBefore(description, gallery);//将图片占位符插入图片库前面
