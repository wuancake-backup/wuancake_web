...
myindex_article=dao.getSqlAForB("posts", "pauthor", myindex_uname);
                    	    
                    	    if(myindex_logo.endsWith("")){
        ...
        <div class="">
            <div class="col-md-9 col-sm-12 border-r">
                <div class="nav-tabs hidden-xs">
                    <h2 class=" h2"><%=myindex_uname%>的文章</h2>
                    <ul class="nav nav-ul">
                        <li><a href="#">热度</a></li>
                ...
                <div  class="modal-body body-list ">
                    ...
                    <%
                   String plogo=null;
					List<Posts> test=new Dao().getList("posts","pauthor", "admin");
					for(Posts k:test){ %>
                        ...
                        <div>
                            ...
                            <p><label><a href="list.jsp?tid=<%=k.getTid() %>"><%=new Dao().getXXval("theme", "tid", k.getTid(), "tname") %></a></label><%=k.getPclick() %>次浏览  <%=k.getPreplies() %>个回复</p>
                        </div>
                         <%
                         if(puname!=null){
            ...
            <div class="col-md-3 hidden-xs hidden-sm body-list">
                ...
                <div class="col-sm-12 r_div_PaddingAndBorder">
                    ...
                    <a  href="javascript:void(0)">
                        <img src="<%=myindex_logo %>" width="40px" height="40px" alt="img 40px ">
                    </a>
                    <div>
                        <h4><a href="#"><%=myindex_uname%></a></h4>
                        <p><%=myindex_article %> 篇文章 </p>
                    </div>
                </div>
                <div class="col-sm-12 r_div_PaddingAndBorder">
                    <div>
                        <h4 class="sr-only">档案</h4>
                        <p><label>ＱＱ</label><%=myindex_uqq %></p>
                    </div>
                </div>
